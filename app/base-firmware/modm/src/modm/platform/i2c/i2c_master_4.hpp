...
#ifndef MODM_STM32_I2C_4_HPP
#define MODM_STM32_I2C_4_HPP
...
/**
 * I2cMaster implementation of I2C4 module.
 *
 ...
 * @ingroup		modm_platform_i2c modm_platform_i2c_4
 */
class I2cMaster4 : public ::modm::I2cMaster
{
public:
...
private:
	...
	calculateTimings()
	{
		constexpr I2cParameters parameters = {
			.peripheralClock = SystemClock::I2c4,
...
public:
	...
	{
		using Connector = GpioConnector<Peripheral::I2c4, Signals...>;
		...
		static_assert(sizeof...(Signals) == 2 and
					  ...
					  "I2cMaster4::connect() requires one Scl and one Sda signal!");
