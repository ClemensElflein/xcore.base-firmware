...
void
modm::platform::I2cMaster4::initializeWithPrescaler(uint32_t timingRegisterValue, uint8_t isrPriority)
{
	...
	NVIC_SetPriority(I2C4_ER_IRQn, isrPriority);
	NVIC_EnableIRQ(I2C4_ER_IRQn);

	// Enable Event Interrupt
	NVIC_SetPriority(I2C4_EV_IRQn, isrPriority);
