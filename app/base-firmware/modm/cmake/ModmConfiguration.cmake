...
function(modm_targets_create project_name)
  ...
  add_custom_command(TARGET ${project_name}
    POST_BUILD
    COMMAND cmake -E env PYTHONPATH=${PROJECT_SOURCE_DIR}/modm ${Python3_EXECUTABLE} -m modm_tools.size ${project_name}.elf \"[{'name': 'itcm', 'access': 'rwx', 'start': 0, 'size': 65536}, {'name': 'flash', 'access': 'rx', 'start': 134217728, 'size': 1048576}, {'name': 'dtcm', 'access': 'rwx', 'start': 536870912, 'size': 131072}, {'name': 'd1_sram', 'access': 'rwx', 'start': 603979776, 'size': 327680}, {'name': 'd2_sram1', 'access': 'rwx', 'start': 805306368, 'size': 16384}, {'name': 'd2_sram2', 'access': 'rwx', 'start': 805322752, 'size': 16384}, {'name': 'd3_sram', 'access': 'rwx', 'start': 939524096, 'size': 16384}, {'name': 'backup', 'access': 'rwx', 'start': 947912704, 'size': 4096}]\")
  add_custom_target(size DEPENDS ${project_name}.elf)
  add_custom_command(TARGET size
    USES_TERMINAL
    COMMAND cmake -E env PYTHONPATH=modm ${Python3_EXECUTABLE} -m modm_tools.size ${PROJECT_BINARY_DIR}/src/${project_name}.elf \"[{'name': 'itcm', 'access': 'rwx', 'start': 0, 'size': 65536}, {'name': 'flash', 'access': 'rx', 'start': 134217728, 'size': 1048576}, {'name': 'dtcm', 'access': 'rwx', 'start': 536870912, 'size': 131072}, {'name': 'd1_sram', 'access': 'rwx', 'start': 603979776, 'size': 327680}, {'name': 'd2_sram1', 'access': 'rwx', 'start': 805306368, 'size': 16384}, {'name': 'd2_sram2', 'access': 'rwx', 'start': 805322752, 'size': 16384}, {'name': 'd3_sram', 'access': 'rwx', 'start': 939524096, 'size': 16384}, {'name': 'backup', 'access': 'rwx', 'start': 947912704, 'size': 4096}]\"
  ...
  add_custom_command(TARGET program-jlink
    USES_TERMINAL
    COMMAND cmake -E env PYTHONPATH=modm ${Python3_EXECUTABLE} -m modm_tools.jlink -device stm32h723zg
        ${PROJECT_BINARY_DIR}/src/${project_name}.elf
    WORKING_DIRECTORY ${PROJECT_SOURCE_DIR})
  ...
  add_custom_command(TARGET reset-jlink
    USES_TERMINAL
    COMMAND cmake -E env PYTHONPATH=modm ${Python3_EXECUTABLE} -m modm_tools.jlink -device stm32h723zg --reset
    WORKING_DIRECTORY ${PROJECT_SOURCE_DIR})
  ...
  add_custom_command(TARGET log-itm-jlink
    USES_TERMINAL
    COMMAND cmake -E env PYTHONPATH=modm ${Python3_EXECUTABLE} -m modm_tools.itm jlink -device stm32h723zg
    WORKING_DIRECTORY ${PROJECT_SOURCE_DIR})
  ...
  add_custom_command(TARGET log-rtt-jlink
    USES_TERMINAL
    COMMAND cmake -E env PYTHONPATH=modm ${Python3_EXECUTABLE} -m modm_tools.rtt --channel ${MODM_RTT_CHANNEL} jlink -device stm32h723zg
    WORKING_DIRECTORY ${PROJECT_SOURCE_DIR})
endfunction()
